...
; FINE-GRAINED-NEXT:    nopa ; nopb ; nopx ; mov dj3, r15; nops
; FINE-GRAINED-NEXT:    vlda x2, [sp, #-192]; movs dj7, r9; mov dn3, r10 // 64-byte Folded Reload
; FINE-GRAINED-NEXT:    mova dn1, #0; movs m3, r14; mov dj1, #1
; FINE-GRAINED-NEXT:    lda dj0, [sp, #-64]; movs dn7, r11; mov r3, dn1 // 4-byte Folded Reload
; FINE-GRAINED-NEXT:    vlda x3, [sp, #-128]; movs m4, dj1; mov r4, dn1 // 64-byte Folded Reload
; FINE-GRAINED-NEXT:    movs dc2, dn1; mov r21, dj1
; FINE-GRAINED-NEXT:    mova dc0, #0; movs dc7, dn1; mov r20, dn1
; FINE-GRAINED-NEXT:    mova m5, #0; movs dc3, dn1; mov r5, dn1
; FINE-GRAINED-NEXT:    lda r19, [sp, #-60]; movs dc6, dn1; mov dn0, m5 // 4-byte Folded Reload
; FINE-GRAINED-NEXT:    lda r0, [sp, #-56]; movs m0, m5; movx r18, #0; mov dn4, m5 // 4-byte Folded Reload
; FINE-GRAINED-NEXT:    mova dj4, #1; st dj0, [sp, #-64]; movx r7, #1; vmov lfl0, x2 // 4-byte Folded Spill
; FINE-GRAINED-NEXT:    lda r1, [sp, #-52]; movs dj0, m5; and r16, r12, r7; vmov lfh0, x3 // 4-byte Folded Reload
; FINE-GRAINED-NEXT:  .LBB0_1: // %for.body.i
; FINE-GRAINED-NEXT:    // =>This Loop Header: Depth=1
; FINE-GRAINED-NEXT:    // Child Loop BB0_2 Depth 2
; FINE-GRAINED-NEXT:    nopa ; nopb ; nopx ; mov dj2, p6
; FINE-GRAINED-NEXT:    movs dn2, r3; mov r17, dc6
; FINE-GRAINED-NEXT:    movs dn6, r3; or r6, r5, r5; mov r5, dj4
; FINE-GRAINED-NEXT:    movs m2, m4; vmov lfl1, lfl0
; FINE-GRAINED-NEXT:    movs dj6, p6; mov m1, m5
; FINE-GRAINED-NEXT:    movs dj1, m5; mov dn1, r3
; FINE-GRAINED-NEXT:    movs dc1, dc0; mov dn5, r3
; FINE-GRAINED-NEXT:    mova p0, #0; movs dj5, m5; mov dc5, r20
; FINE-GRAINED-NEXT:    mova p1, #0; paddb.3d [p0], d1; or r25, r18, r18; vmov lfh1, lfh0; movs dc6, r4
; FINE-GRAINED-NEXT:    mova p0, #0; vldb.pop.576.3d ex0, [p1, lf1, r25, d2]; mov r20, dc5
...
; FINE-GRAINED-NEXT:    nops ; mov dn1, dn3
; FINE-GRAINED-NEXT:    movs dj1, dj3; mov dn5, dn7
; FINE-GRAINED-NEXT:    mova p0, #0; movs dj5, dj7; mov dc0, r6
; FINE-GRAINED-NEXT:    lda dj3, [sp, #-64]; movs dj4, r5; mov m1, m3 // 4-byte Folded Reload
; FINE-GRAINED-NEXT:    movs dc4, m5; paddb.3d [p0], d3; mov m3, m5
; FINE-GRAINED-NEXT:    movs dn3, m5; mov dc5, dc7
; FINE-GRAINED-NEXT:    movs dc1, dc3; xor r17, r12, r7; mov dc3, r17
; FINE-GRAINED-NEXT:    mova p0, #0; movs dc7, r21; and r6, r17, r7; mov r21, m5
; FINE-GRAINED-NEXT:    movs dj7, r19; paddb.3d [p0], d0; jnz r6, #.LBB0_1
; FINE-GRAINED-NEXT:    mova p1, #0; movs dn7, m5; mov r5, dc0 // Delay Slot 5
; FINE-GRAINED-NEXT:    movs m3, m1; paddb.3d [p1], d3; mov dn3, dn1 // Delay Slot 4
; FINE-GRAINED-NEXT:    mova dc0, #0; movs dj3, dj1; mov dn7, dn5 // Delay Slot 3
; FINE-GRAINED-NEXT:    movs dj7, dj5; mov dc6, dc3 // Delay Slot 2
; FINE-GRAINED-NEXT:    movs dc3, dc1; mov dc7, dc5 // Delay Slot 1
