...
AIE2PInstrInfo::AIE2PInstrInfo(const AIEBaseSubtarget &STI, const TargetRegisterInfo &TRI)
    : AIE2PGenInstrInfo(STI, TRI, AIE2P::ADJCALLSTACKUP, AIE2P::ADJCALLSTACKDOWN) {
